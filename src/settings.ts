...
export function sanitizeSettings(input: Partial<BetterSimTrackerSettings>): BetterSimTrackerSettings {
  ...
  return {
    ...
    lastThoughtPrivate: asBool(input.lastThoughtPrivate, defaultSettings.lastThoughtPrivate),
    enableUserTracking: asBool(input.enableUserTracking, defaultSettings.enableUserTracking),
    userTrackMood: asBool(input.userTrackMood, defaultSettings.userTrackMood),
    userTrackLastThought: asBool(input.userTrackLastThought, defaultSettings.userTrackLastThought),
    includeUserTrackerInInjection: asBool(input.includeUserTrackerInInjection, defaultSettings.includeUserTrackerInInjection),
    ...
    promptProtocolSequentialConnection: asText(input.promptProtocolSequentialConnection, defaultSettings.promptProtocolSequentialConnection).slice(0, 20000),
